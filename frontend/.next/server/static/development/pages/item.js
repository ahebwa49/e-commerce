...
})(["max-width:1200px;margin:2rem auto;box-shadow:", ";display:grid;grid-template-areas:\"image more\";@media (max-width:700px){grid-template-areas:\"image\" \"more\";}min-height:800px;img{grid-area:image;width:100%;height:auto;object-fit:contain;}.details{grid-area:more;display:grid;justify-items:center;align-self:start;align-items:center;margin:3rem;font-size:2rem;}.description{display:grid;justify-items:center;align-self:center;align-items:center;font-size:2rem;}.addtocart{cursor:pointer;display:grid;justify-items:center;align-self:center;align-items:center;font-size:2rem;border:1px solid green;background-color:#09a7a1;color:white;}.modify{cursor:pointer;display:grid;justify-items:center;align-self:center;align-items:center;font-size:2rem;}.edit{cursor:pointer;display:grid;justify-items:stretch;align-self:center;align-items:center;font-size:2rem;background-color:#ff790e;color:white;}.delete{cursor:pointer;display:grid;justify-items:center;align-self:center;align-items:center;font-size:2rem;background-color:red;color:white;}"], function (props) {
