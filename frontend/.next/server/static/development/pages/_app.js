...
})(["background:", ";color:white;border-radius:50%;padding:0.5rem;line-height:2rem;min-width:2rem;margin-left:0.5rem;font-weight:100;font-feature-settings:\"tnum\";font-variant-numeric:tabular-nums;"], function (props) {
...
/* harmony import */ var _MenuApp__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./MenuApp */ "./components/MenuApp.js");
...
function (_Component) {
  ...
  function Page(props) {
    ...
    _this.handleMenuButtonClick = _this.handleMenuButtonClick.bind(_assertThisInitialized(_assertThisInitialized(_this)));
  ...
  _createClass(Page, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(styled_components__WEBPACK_IMPORTED_MODULE_4__["ThemeProvider"], {
        ...
        __self: this
      }), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_MenuApp__WEBPACK_IMPORTED_MODULE_5__["default"], {
        menuOpen: this.state.menuOpen,
        __source: {
          fileName: _jsxFileName,
          lineNumber: 80
...
})(["padding:20px;position:relative;background:white;position:fixed;height:100%;top:0;right:0;width:40vw;min-width:300px;bottom:0;transform:translateX(100%);transition:all 0.3s;box-shadow:0 0 10px 3px rgba(0,0,0,0.2);z-index:5;display:grid;grid-template-rows:auto 1fr auto;", ";header{border-bottom:5px solid ", ";margin-bottom:2rem;padding-bottom:2rem;}footer{border-top:10px double ", ";margin-top:2rem;padding-top:2rem;display:grid;grid-template-columns:auto auto;align-items:center;font-size:3rem;font-weight:900;p{margin:0;}}ul{margin:0;padding:0;list-style:none;overflow:scroll;}@media (max-width:700px){font-size:16px;width:90%;height:70%;padding:5px;margin-bottom:5px;padding-bottom:5px;footer{border-top:3px double ", ";margin-top:5px;padding-top:5px;display:grid;grid-template-columns:auto auto;align-items:center;font-size:16px;font-weight:600;}}"], function (props) {
...
})(["display:grid;position:relative;justify-items:stretch;align-items:center;border-radius:3%;input{width:100%;padding:10px;border:1px solid ", ";border-radius:3%;font-size:2rem;@media (max-width:700px){font-size:1.5rem;}&.loading{animation:", " 0.5s ease-in-out infinite alternate;}}"], function (props) {
  return props.theme.lightgrey;
}, glow);
...
})(["margin:auto;padding:auto;display:flex;justify-self:end;font-size:2rem;a,button{padding:1rem 2rem;display:flex;align-items:center;position:relative;text-transform:uppercase;font-weight:900;font-size:1em;background:none;border:0;cursor:pointer;@media (max-width:700px){padding:auto;margin:auto;width:100%;}&:before{content:\"\";width:2px;background:", ";height:100%;left:0;position:absolute;transform:skew(-20deg);top:0;bottom:0;}&:after{height:2px;background:#FF790E;content:\"\";width:0;position:absolute;transform:translateX(-50%);transition:width 0.4s;transition-timing-function:cubic-bezier(1,-0.65,0,2.31);left:50%;margin-top:2rem;}&:hover,&:focus{outline:none;&:after{width:calc(100% - 60px);}@media (max-width:700px){width:calc(100% - 10px);}}}@media (max-width:1300px){width:100%;justify-content:center;font-size:1.5rem;}@media (max-width:1135px){font-size:1.4rem;}@media (max-width:1035px){font-size:1.3rem;}@media (max-width:700px){font-size:12px;}"], function (props) {
  return props.theme.lightgrey;
});
...
})(["background:#FF790E;color:white;font-weight:500;border:0;border-radius:0;text-transform:uppercase;font-size:2rem;padding:0.8rem 1.5rem;transform:skew(-2deg);display:inline-block;transition:all 0.5s;&[disabled]{opacity:0.5;}"]);
...
})(["background:", ";color:white;display:inline-block;padding:4px 5px;transform:skew(-3deg);margin:0;font-size:4rem;@media (max-width:700px){font-size:2rem;}"], function (props) {
  return props.theme.red;
});
