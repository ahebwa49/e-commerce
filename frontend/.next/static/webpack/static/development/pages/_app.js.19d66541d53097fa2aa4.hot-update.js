...
})(["display:flex;justify-content:center;font-size:4rem;margin-left:2rem;position:relative;border:1px solid red;margin:15% 0;z-index:2;transform:skew(0deg);a{padding:0.5rem 1rem;background:", ";text-transform:uppercase;color:white;text-decoration:none;}@media (max-width:1300px){margin:0;text-align:center;}@media (max-width:700px){font-size:2rem;margin:5% 0;justify-content:start;transform:0;a{padding:0.5rem 0;justify-content:start;}}"], function (props) {
...
//# sourceMappingURL=_app.js.19d66541d53097fa2aa4.hot-update.js.map